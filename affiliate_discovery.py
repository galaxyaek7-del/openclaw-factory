...
NEWLY_VERIFIED_PROGRAMS: List[dict] = [
    {
        ...
        "commission_value": "10% of referred customer's monthly spend, paid monthly for one full year per paying user (via CJ network)",
        "commission_currency": "USD",
        "recurring_commission": True,
        "commission_duration": "12 months of the customer's monthly spend (per official program page)",
        "minimum_conditions": "Application-based via CJ (Commission Junction) affiliate network; leads accepted/validated by DigitalOcean",
        ...
        "payout_terms": "UNKNOWN -- set in the CJ affiliate tool once accepted",
        "eligibility": "Anyone can join via the CJ affiliate network signup link (official page)",
