...
function readHealthSnapshots(snapshotsPath = DEFAULT_SNAPSHOTS_PATH, limit = 50) {
  // Shared primitive (lib/jsonl.js) -- same corrupt-line-skipping, tail-N
  // discipline every other JSONL reader in this repo already uses.
  return readJsonlEntries(snapshotsPath, limit);
}
