...
| 2026-07-31 | The founder's "Truth First Constitution" directive (ADR-160) was ratified into `OPENCLAW_OS_CONSTITUTION.md`'s new "TRUTH FIRST" section (immediately after Supreme Law) — this document's own §20 Self-Awareness is a real, narrower precedent for the same discipline, cited there rather than duplicated here. |
